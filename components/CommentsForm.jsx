  ...
  return (
    <div className = "bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className = "grid grid-cols-1 gap-4 mb-4">
          ...
          className = "pb-4 outline-none w-full rounded-lg focus:ring-2 focus:ring-gray-200 bg-gray-100 text-gray-700 px-4 py-2"
          placeholder = "comment"
          name = "comment" 
          />
      </div>
      ...
      <div className = "grid grid-cols-1 gap-4 mb-4">
        <div>
          ...
          <label className = "text-gray-500 cursor-pointer ml-2" htmlFor = "storeData">Save my name and email for the nexttime</label>
        </div>
      </div>
